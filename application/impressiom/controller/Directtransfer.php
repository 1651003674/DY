...
/**
 * Class Directtransfer 直接调拨单
 * @package app\impressiom\controller
 */
class Directtransfer extends Controller
{
    /**
     * @name 销售出库单 同步界面
     * @return mixed
...
//var_dump($kvArr);die();
    ...
    public function Asyc(){
        ...
        try{
            ...
            return ( new DocumentsModel( WiseDB::getConnect( request()->param('orgId') ) ) )->save( [new \app\impressiom\model\Directtransfer(),'save'] );
        }catch (Exception $e){
