...
class Stepbystepout extends Controller
{
    /**
     * @name 销售出库单 同步界面
     * @return mixed
...
//var_dump($kvArr);die();
    ...
    public function Asyc(){
        ...
        try{
            ...
            return ( new DocumentsModel( WiseDB::getConnect( request()->param('orgId') ) ) )->save( [new \app\impressiom\model\StepByStepOut(),'save'] );
        }catch (Exception $e){
